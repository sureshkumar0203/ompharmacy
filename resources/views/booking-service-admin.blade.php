    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="test-det">
          ...
          <input id="lat" name="lat" type="hidden" value="<?php if($userData->lat != '' && $userData->lat != null){ echo $userData->lat; }else{ echo "20.3148233"; } ?>">
          <input id="lng" name="lng" type="hidden" value="<?php if($userData->lng != '' && $userData->lng != null){ echo $userData->lng; }else{ echo "85.82074920000002"; } ?>">
          <div class="row">
...
<script>
function initialize() {
var latlng = new google.maps.LatLng(<?php if($userData->lat != '' && $userData->lat != null){ echo $userData->lat; }else{ '20.3148233'; }  ?>,<?php if($userData->lng != '' && $userData->lng != null){ echo $userData->lng; }else{ '85.82074920000002'; } ?>);
