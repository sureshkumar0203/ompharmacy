      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            ...
            {{ Form::open(['route' => 'banners.store', 'role' => 'form', 'class' =>'form-horizontal form-label-left', 'name' => 'add-banners', 'id' => 'add-banners','files'=>true, 'autocomplete' => 'off', 'novalidate']) }}
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Text 1 <span class="required">*</span> </label>
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::text('title',old('title'), ['id' => 'title','required', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Title', 'maxlength' => '33']) !!}
                  @if ($errors->has('title'))
              ...
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::textarea('description',old('description'), ['id' => 'description','required', 'class'=>'form-control col-md-7 col-xs-12', 'rows' =>'4', 'maxlength' => '255', 'placeholder'=>'Description']) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::text('link',old('link'), ['id' => 'link', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Link']) !!}
                  @if ($errors->has('link'))
                  <span class="help-block">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">Banner <span class="required">*</span> </label>
                <div class="col-md-5 col-sm-6 col-xs-12">
