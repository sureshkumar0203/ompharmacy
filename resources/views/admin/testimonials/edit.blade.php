      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            ...
            {!! Form::model($testimonials, ['method' => 'PATCH', 'role' => 'form', 'class' =>'form-horizontal form-label-left', 'name' => 'edit-testimonials', 'id' => 'edit-testimonials','files'=>true, 'autocomplete' => 'off', 'novalidate', 'route' => ['testimonials.update', $testimonials->id]]) !!}
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name <span class="required">*</span> </label>
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::text('name', old('name',$testimonials->name),['id' => 'name', 'required', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Name']) !!}
                  @if ($errors->has('name'))
              ...
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::textarea('description', old('description',$testimonials->description),['id' => 'description', 'maxlength' =>'255', 'required', 'class'=>'form-control col-md-7 col-xs-12', 'rows' =>'3', 'placeholder'=>'Description']) !!}
                  @if ($errors->has('name'))
                  <span class="help-block">
                    <strong>{{ $errors->first('name') }}</strong>
                  </span>
              ...
              <div class="item form-group">
                ...
                @if($testimonials->image != null)
                  <div id="testimonialImagePreview"><img src="{{ asset('public/images/testimonials') }}/{{ $testimonials->image }}" alt="" height="100px"></div>
                @endif
                </div>
              </div>
