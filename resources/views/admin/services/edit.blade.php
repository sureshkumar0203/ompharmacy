      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            ...
            {!! Form::model($data, ['method' => 'PATCH', 'role' => 'form', 'class' =>'form-horizontal form-label-left', 'name' => 'edit-services', 'id' => 'edit-services','files'=>true, 'autocomplete' => 'off', 'novalidate', 'route' => ['services.update', $data->id]]) !!}
            {!! Form::hidden('id', $data->id) !!}
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::select('cms_id',$pages,$data->cms_id, ['id' => 'cms_id', 'required', 'class'=>'form-control']) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::text('test_id', old('test_id', $data->test_id),['id' => 'test_id', 'required', 'class'=>'form-control col-md-7 col-xs-12', 'readonly', 'placeholder'=>'Service Id']) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::text('name', old('name', $data->name),['id' => 'name', 'required', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Service Name']) !!}
                  @if ($errors->has('name'))
                  <span class="help-block">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::textarea('shot_description',old('name', $data->shot_description), ['id' => 'shot_description','required', 'class'=>'form-control  ckeditor', 'rows' =>'3', 'placeholder'=>'Address']) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::text('sale_price', old('sale_price', $data->sale_price), ['onKeyUp' => 'validatePrice(this)', 'id' => 'sale_price','required', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Price']) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-2 col-sm-3 col-xs-12">
                  {!! Form::text('hour', old('hour', $data->hour), ['onkeypress' => 'return isNumber(event)', 'id' => 'hour','required', 'min'=>'0', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Hour', 'maxlength'=>'3']) !!}
                  @if ($errors->has('hour'))
                    <span class="help-block">
                ...
                <div class="col-md-2 col-sm-3 col-xs-12">
                  {!! Form::text('minute', old('minute', $data->minute), ['onkeypress' => 'return isNumber(event)', 'id' => 'minute','required', 'min'=>'0', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Minute', 'maxlength'=>'2']) !!}
