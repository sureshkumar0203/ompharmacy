      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            ...
            {{ Form::open(['route' => 'blogs.store', 'role' => 'form', 'class' =>'form-horizontal form-label-left', 'name' => 'add-blogs', 'id' => 'add-blogs','files'=>true, 'autocomplete' => 'off', 'novalidate']) }}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  {!! Form::textarea('sort_description',old('sort_description'), ['id' => 'sort_description','required', 'class'=>'form-control col-md-7 col-xs-12', 'rows' =>'4', 'placeholder'=>'Sort Description']) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  {!! Form::textarea('meta_title',old('meta_title'), ['id' => 'meta_title','required', 'class'=>'form-control col-md-7 col-xs-12', 'rows' =>'4', 'placeholder'=>'Meta Title']) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  {!! Form::textarea('meta_keyword',old('meta_keyword'), ['id' => 'meta_keyword','required', 'class'=>'form-control col-md-7 col-xs-12', 'rows' =>'4', 'placeholder'=>'Meta Keyword']) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  {!! Form::textarea('meta_description',old('meta_description'), ['id' => 'meta_description','required', 'class'=>'form-control col-md-7 col-xs-12', 'rows' =>'4', 'placeholder'=>'Meta Description']) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::text('author',old('author'), ['id' => 'author', 'required', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Author']) !!}
              ...
              <div class="item form-group">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="image">Image <span class="required">*</span> </label>
                <div class="col-md-5 col-sm-6 col-xs-12">
