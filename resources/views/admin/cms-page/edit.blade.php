...
@section('title','Edit Category Content')
@section('css')
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            ...
            {!! Form::model($cmsPage, ['method' => 'PATCH', 'role' => 'form', 'class' =>'form-horizontal form-label-left', 'name' => 'edit-cms', 'id' => 'edit-cms','files'=>true, 'autocomplete' => 'off', 'novalidate', 'route' => ['cms-page.update', $cmsPage->id]]) !!}
              <div class="item form-group">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="title">Title <span class="required">*</span> </label>
                <div class="col-md-8 col-sm-8 col-xs-12">
                  {!! Form::text('title',old('title', $cmsPage->title), ['id' => 'title','required', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Title']) !!}
                  @if ($errors->has('title'))
              ...
              <div class="item form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  ...
                  <?php foreach($res as $cl) { ?>
                    <option value="<?php echo $cl["id"] ?>" <?php if($cmsPage->parent_id == $cl['id']){ echo "selected"; } ?>><?php echo $cl["name"]; ?></option>
                  <?php } ?>
                  </select>
              ...
              <div class="item form-group" id="ser_request" @if($cmsPage->parent_id != 0) style="display:none" @else style="display:block" @endif>
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="service_request">Send Service Request </label>
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <div class="checkbox">
                    <label>
                      {!! Form::checkbox('service_request','1', $cmsPage->service_request ? 'checked="checked"' : '0', ['id'=>'service_request']) !!} <strong>Only Admin</strong>
                    </label>
                  </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  {!! Form::textarea('description',old('description', $cmsPage->description), ['id' => 'description','required', 'class'=>'form-control col-md-7 col-xs-12 ckeditor', 'rows' =>'3', 'placeholder'=>'Address']) !!}
           ...
           @if(noServiceCheck($cmsPage->id) != true)
              <div class="item form-group" id="service_time" @if($cmsPage->parent_id != 0) style="display:none" @else style="display:block" @endif>
              ...
              <div class="item form-group" id="time-restriction" style="@if($cmsPage->time24_status == 0) display:none; @else display:block; @endif">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="title">Booking Time <span class="required">*</span> </label>
                <div class="col-md-2 col-sm-2 col-xs-12">
                  {!! Form::text('from_time',old('from_time', date("g:i A", strtotime($cmsPage->from_time))), ['id' => 'from_time', 'class'=>'form-control col-md-7 col-xs-12', 'readonly'=>'readonly', 'placeholder'=>'From Time']) !!}
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                  {!! Form::text('to_time',old('to_time', date("g:i A", strtotime($cmsPage->to_time))), ['id' => 'to_time', 'class'=>'form-control col-md-7 col-xs-12', 'readonly'=>'readonly', 'placeholder'=>'To Time']) !!}
            ...
            @endif
              ...
              <div class="item form-group" id="file-image" @if($cmsPage->parent_id != 0) style="display:none" @else style="display:block" @endif>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  ...
                  {!! Form::hidden('old_image', $cmsPage->image) !!}
                ...
                @endif
                <div id="imageView"><img src="{{ asset('public/images/services') }}/{{ $cmsPage->image }}" alt=""></div>
                </div>
              </div>
              <div class="item form-group" id="bann-image" @if($cmsPage->parent_id != 0) style="display:none" @else style="display:block" @endif>
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="banner_img">Banner Image </label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                  {!! Form::file('banner_img', ['id' => 'banner_img', 'class'=>'form-control col-md-7 col-xs-12', 'onchange'=>'return bannerFileValidation()', 'accept'=>'image/x-png, image/jpeg']) !!}
                  {!! Form::hidden('old_banner_img', $cmsPage->banner_img) !!}
                ...
                @endif
                <div id="banner_imageView"><img src="{{ asset('public/images/services/banner/') }}/{{ $cmsPage->banner_img }}" alt=""></div>
                </div>
              </div>
              <div class="item form-group" id="adv-image" @if($cmsPage->parent_id != 0) style="display:none" @else style="display:block" @endif>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  ...
                  {!! Form::hidden('old_adv_image', $cmsPage->adv_img) !!}
                ...
                @endif
                <div id="advertisement_imageView">@if($cmsPage->adv_img !='' || null)<img src="{{ asset('public/images/services/advertisement/') }}/{{ $cmsPage->adv_img }}" alt="">@endif</div>
                </div>
              </div>
              <div class="item form-group" id="button-text" @if($cmsPage->parent_id != 0) style="display:none" @else style="display:block" @endif>
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="btn_name">Button Text name <span class="required">*</span> </label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                  {!! Form::text('btn_name',old('btn_name', $cmsPage->btn_name), ['id' => 'btn_name','required', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Button Text name']) !!}
