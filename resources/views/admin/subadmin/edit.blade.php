      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            ...
            {!! Form::model($data, ['url' => 'administrator/subadmin/update', 'role' => 'form', 'class' =>'form-horizontal form-label-left', 'name' => 'edit-subadmin', 'id' => 'edit-subadmin','files'=>true, 'autocomplete' => 'off', 'novalidate']) !!}
            {!! Form::hidden('id', $data->id) !!}
              ...
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::text('email', old('email', $data->email),['id' => 'email', 'required', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'E-mail']) !!}
                  @if ($errors->has('email'))
                  <span class="help-block">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  {!! Form::text('phone_no', old('phone_no', $data->phone_no), ['onkeypress' => 'return isNumber(event)', 'id' => 'phone_no','required', 'class'=>'form-control col-md-7 col-xs-12', 'maxlength'=>'10', 'placeholder'=>'Phone']) !!}
